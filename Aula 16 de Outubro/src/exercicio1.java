...
/*
			...
			1- Fazer um programa que conte quantos numeros divisiveis por "i" 
		       (lido pelo usuario) em uma matriz n x n;
	        2- Fazer um programa que faça um somatorio de todos os elementos de uma matriz de tamanho 
	           generico, dados lidos pelo usuario;
	        3- Imprimir as duas diagonais de uma matriz generica;
	        4- somar todos os elementos das duas diagonais de uma matriz generica;
	        5- Em uma matriz, apenas preenchidas por "0's" e "1's", fazer um programa que detecte tres uns em sequencia. 
	           Eles podem ser vertical ou horizontal.
 */
